...
/// {@template assets_generator.{0}.preview}
/// ![]({1})
/// {@endtemplate}
...
/// {@macro assets_generator.{0}.preview}
''';
...
class Template {
  ...
  Future<String> generateFile(
    ...
    sb.write(classDeclare.replaceAll('{0}', className));
